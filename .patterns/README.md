...
- **[documentation.md](./documentation.md)** - **🚨 MANDATORY for ALL documentation** - Minimal documentation standards, safety documentation for `_unchecked` functions with `# Safety` sections and `// SAFETY:` callsite comments, `# Panics` sections, error enum documentation format, and Cargo.toml feature documentation. MUST be consulted before writing rustdocs or adding features.
