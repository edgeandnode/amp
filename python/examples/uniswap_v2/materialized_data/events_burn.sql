...
SELECT
    ...
    evm_decode(l.topic1, l.topic2, l.topic3, l.data, 'Burn(address indexed sender, uint256 amount0, uint256 amount1, address indexed to)') AS params
FROM
    eth_firehose.logs l
JOIN
    uniswap_token_pairs u ON l.address = u.param_pair_contract_address  -- Changed to JOIN
WHERE
    l.topic0 = arrow_cast(x'dccd412f0b1252819cb1fd330b93224ca42612892bb3f4f789976e6d81936496', 'FixedSizeBinary(32)')
