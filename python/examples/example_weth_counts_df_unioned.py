...
class example_weth_counts_df_unioned(View):
    ...
    def query(self) -> datafusion.DataFrame:
        ...
        def df_operations(ctx: SessionContext) -> DataFrame:
            ...
            return (
                ...
                .with_column("events_per_day", f.col("event_count") / f.col("num_days"))
...
if __name__ == "__main__":
    ...
    example_weth_counts_view = example_weth_counts_df_unioned(start_block=20700000, end_block=None)
