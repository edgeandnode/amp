//! ampctl fixture for registering dataset manifests.
//!
//! This fixture provides a convenient interface for registering dataset manifests
//! with the Admin API in test environments. It wraps the manifest registration logic
//! from the ampctl CLI tool.
...
/// ampctl fixture for registering dataset manifests.
///
/// This fixture provides methods for registering dataset manifests with the
/// Admin API. It automatically handles the HTTP request formatting and error handling.
#[derive(Clone, Debug)]
pub struct Ampctl {
    admin_url: Url,
}
...
impl Ampctl {
    ...
    /// for manifest registration requests.
    ///
    /// # Panics
    ///
