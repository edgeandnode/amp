 ...
 */
export const basicQueries: TestQuery[] = [
  {
    query: "SELECT * FROM ",
 ...
 */
export const qualifiedNameQueries: TestQuery[] = [
  {
 ...
 */
export const udfQueries: TestQuery[] = [
  {
    query: "SELECT evm_",
 ...
 */
export const complexQueries: TestQuery[] = [
  {
 ...
 */
export const stringAndCommentQueries: TestQuery[] = [
  {
 ...
 */
export const edgeCaseQueries: TestQuery[] = [
  {
    query: "SELECT FROM ",
 ...
 */
export function getQueriesByCategory(category: string): TestQuery[] {
  switch (category) {
    case 'basic': return basicQueries
    case 'qualified': return qualifiedNameQueries
    case 'udf': return udfQueries
    case 'complex': return complexQueries
    case 'string-comment': return stringAndCommentQueries
    case 'edge-case': return edgeCaseQueries
    default: return allTestQueries
  }
}