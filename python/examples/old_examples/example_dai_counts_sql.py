...
class example_weth_counts_sql(View):
    def __init__(self, start_block=None, end_block=None):
        super().__init__(
            events=[
                EventRegistry.Dai.Transfer,
                EventRegistry.Dai.Approval
            ],
            start_block=20740000,
            end_block=20760000,
            description = "This view counts the number of DAI approval and transfer events per day."
        )
...
# python3 -m examples.example_dai_counts_sql --start_block 20700000 --end_block 20710000 --run

# To do a test run, use:
# python -m nozzle.examples.example_dai_counts_sql
...
if __name__ == "__main__":
    ...
    example_weth_counts_view = example_weth_counts_sql()
