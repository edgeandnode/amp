...
This skill validates that feature documentation **format** follows the established patterns in `docs/__meta__/features.md`.
...
All format requirements are defined in [docs/__meta__/features.md](../../docs/__meta__/features.md). Read that file for:
...
Use the **Checklist** section in `docs/__meta__/features.md` to validate feature docs.
...
2. **Read the feature doc** and **Read** [docs/__meta__/features.md](../../docs/__meta__/features.md)
3. **Validate** using the checklist in the patterns file
4. **Report** findings using format below

## Review Report Format

After validation, provide a structured report listing issues found. Use the checklist from [docs/__meta__/features.md](../../docs/__meta__/features.md) as the validation criteria.
...
<If FAIL, provide specific fixes needed referencing docs/__meta__/features.md>
```

## Common Issues

When validation fails, refer to [docs/__meta__/features.md](../../docs/__meta__/features.md) for detailed requirements. Common issues include:
