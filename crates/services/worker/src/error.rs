...
pub enum SpawnJobError {
    ...
    ///
    /// This occurs when constructing the job instance from the parsed descriptor fails.
    /// Job creation involves resolving datasets, tables, and other resources needed
    /// for job execution.
    ///
