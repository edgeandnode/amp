//! Dataset implementation for Canton Scan API datasets.
...
use crate::CantonScanDatasetKind;

/// Canton Scan API dataset definition.
pub struct Dataset {
    pub(crate) tables: Vec<Table>,
    pub(crate) start_block: Option<BlockNum>,
    pub(crate) kind: CantonScanDatasetKind,
