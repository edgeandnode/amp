...
| pre_token_balances        | List(Struct(account_index: UInt8, mint: Utf8, ui_token_amount: Struct(decimals: UInt8, amount: Utf8, ui_amount_string: Utf8), owner: Utf8, program_id: Utf8)) | YES         |
| post_token_balances       | List(Struct(account_index: UInt8, mint: Utf8, ui_token_amount: Struct(decimals: UInt8, amount: Utf8, ui_amount_string: Utf8), owner: Utf8, program_id: Utf8)) | YES         |
