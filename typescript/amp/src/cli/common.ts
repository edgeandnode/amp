...
export const adminUrl = Options.text("admin-url").pipe(
  Options.withFallbackConfig(
    Config.string("AMP_ADMIN_URL").pipe(
...
export const flightUrl = Options.text("flight-url").pipe(
  Options.withFallbackConfig(
    Config.string("AMP_ARROW_FLIGHT_URL").pipe(
...
export const bearerToken = Options.text("bearer-token").pipe(
  Options.withFallbackConfig(
    Config.string("AMP_AUTH_TOKEN"),
  ),
